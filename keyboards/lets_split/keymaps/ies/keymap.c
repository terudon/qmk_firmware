...
#define I_DSKP LGUI(KC_B)
#define I_DSKN LGUI(KC_N)

#define I_TABP LSFT(LCTL(KC_TAB))
#define I_TABN LCTL(KC_TAB)
...
|------+------+------+------+------+------|  Y  |------+------+------+------+------+------|
| Ctrl | Alt  |Adjust| Tur  | N-N  | iSpc |     | iSpc | N-N  | Fun  |Adjust| Alt  | Ctrl | 
`-----------------------------------------´     `-----------------------------------------'
*/
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LALT, ADJUST,  TURKCE,   NAVNUM, I_SPC,   I_SPC, NAVNUM, FUNCTION,ADJUST,  KC_RALT, KC_RCTL  \
),
...
/*
|      |      |  7   |  8   |  9   |      |  N  |iDskP |iTabP |iTabN |iDskN |      |      |
|------+------+------+------+------+------|  A  |------+------+------+------+------+------|
|      |  0   |  4   |  5   |  6   |      |  V  | Left | Down | Up   |Right |      |      |
|------+------+------+------+------+------|  -  |------+------+------+------+------+------|
|      |      |  1   |  2   |  3   |      |  N  | Home | PgDn | PgUp | End  |      |      |
|------+------+------+------+------+------|  U  |------+------+------+------+------+------|
|      |      |      |      |      |      |  M  |      |      |      |      |      |      |
`-----------------------------------------´     `-----------------------------------------'
 */
[_NAVNUM] = KEYMAP( \
  _______, _______, KC_7   , KC_8   , KC_9   , _______,   I_DSKP,  I_TABP,  I_TABN,  I_DSKN,  _______, _______,\
...
|------+------+------+------+------+------|  U  |------+------+------+------+------+------|
|      | F6   | F7   | F8   | F9   | F10  |  N  |      | Play | Prev | Next |      |      |
|------+------+------+------+------+------|  C  |------+------+------+------+------+------|
|      | F11  | F12  | F13  | F14  | F15  |  T  |      | Mute | Vol- | Vol+ |      |      |
|------+------+------+------+------+------|  I  |------+------+------+------+------+------|
|      |      |      |      |      |      |  O  |      |      |      |      |      |      |
`-----------------------------------------´  N  `-----------------------------------------'
 */
[_FUNCTION] = KEYMAP( \
   ...
   _______, KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 ,    _______, KC_MPLY, KC_MRWD, KC_MFFD, _______, _______, \
   _______, KC_F11 , KC_F12 , KC_F13 , KC_F14 , KC_F15 ,    _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, \
   _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______  \
),
